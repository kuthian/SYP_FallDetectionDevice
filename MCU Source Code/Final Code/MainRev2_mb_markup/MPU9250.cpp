...
{  
 ...
 // Set sample rate = gyroscope output rate/(1 + SMPLRT_DIV)
  writeByte(MPU9250_ADDRESS, SMPLRT_DIV, 0x09);  // Use a 200 Hz rate; a rate consistent with the filter update rate 
 ...
 // accel_fchoice_b bit [3]; in this case the bandwidth is 1.13 kHz
  ...
  c = c | 0x02;  // Set accelerometer rate to 1 kHz and bandwidth to 92 Hz
